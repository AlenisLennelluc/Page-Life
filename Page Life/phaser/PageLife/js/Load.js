...
Load.prototype = {
    ...
    game.load.images(['miniTitle', 'background', 'mask', 'cover'], ['smolTITLE.png', 'background.png', 'mask.png', 'EndMask.png']);
		...
		game.load.images(['scale', 'ckpt', 'credits', 'creditsButton', 'fin', 'so','cText', 'fsText', 'dragEGG', 'bringEgg', 'move', 'jump'], ['FS.PNG', 'checkpoint.PNG', 'credits.png', 'creditsBUTTON.png', 'fin.PNG', 'startOver.PNG', 'cText.PNG', 'fsText.PNG', 'dragEGG.PNG', 'BringEGG.PNG', 'move.PNG', 'jump.PNG']);
